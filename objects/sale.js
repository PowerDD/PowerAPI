		...
		if (data.action == 'saleInfo'){
			...
			if (typeof req.body.shop != 'undefined' && req.body.shop != '' &&
				...
				typeof req.body.saleby  != 'undefined' && req.body.saleby != '' ) {
					data.json.return = false;
					data.json.returnResult = true;
					data.command = 'EXEC sp_Pos_ShopBarcodeUpdate \''+req.body.shop+'\',\''+req.body.saleno+'\',\''+req.body.profit+'\',\''+req.body.totalPrice+'\',\''+req.body.payType+'\',\''+req.body.cash+'\',\''+req.body.credit+'\',\''+req.body.customer+'\',\''+req.body.sex+'\',\''+req.body.age+'\',\''+req.body.saledate+'\',\''+req.body.saleby+'\'';
					data.util.query(req, res, data);
			} 
		}
		else {
